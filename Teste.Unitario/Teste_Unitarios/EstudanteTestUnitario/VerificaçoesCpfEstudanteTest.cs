...
namespace SistemaDeMatricula.Teste.Unit.Teste_Unitarios.EstudanteTestUnitario
{
    public class VerificaçoesCpfEstudanteTest
    {
        ...
        public async Task Deve_Confirmar_Existencia_Quando_Cpf_Estiver_Cadastrado()
        {
            ...
            Assert.Equal(MensagensEstudante.EstudanteJaExiste, resultado.Mensagem); // Combinando com o Use Case
        }
        ...
        public async Task Deve_Limpar_Cpf_Corretamente()
        {
            ...
            // Assert
            Assert.True(resultado.Sucesso);
            Assert.Equal(MensagensEstudante.EstudanteJaExiste, resultado.Mensagem);
        }
